...
class Gens_RAF_Public {
	...
	public function gens_create_send_coupon($order_id) {
		...
		if ( $gens_users && !empty($rafID) ) { // should we check if its id ?
	...
	?>
		<div class="woocommerce-message"><?php _e( 'Your Referal URL:','gens-raf'); ?> <a href="<?php echo $refLink; ?>" ><?php echo $refLink; ?></a></div>
	<?php
	}
